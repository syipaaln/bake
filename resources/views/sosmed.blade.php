...
<link rel="stylesheet" href="{{ asset('sosmed/lightbox.min.css') }}">
<script type="text/javascript" src="{{ asset('sosmed/lightbox-plus-jquery.min.js') }}"></script>
<!------------------LIght BOx for Gallery-------------->
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark mb-4" style="background-color:#3097D1">
        <a href="index.html" class="navbar-brand"><img src="{{ asset('sosmed/img/brand-white.png') }}" alt="logo" class="img-fluid" width="80px" height="100px"></a>
        ...
        <div class="collapse navbar-collapse" id="responsive">
            <ul class="navbar-nav mr-auto text-capitalize">
                <li class="nav-item"><a href="{{ asset('sosmed/index.html') }}" class="nav-link active">home</a></li>
                <li class="nav-item"><a href="{{ asset('sosmed/profile.html') }}" class="nav-link">profile</a></li>
                <li class="nav-item"><a href="{{ asset('sosmed/#modalview') }}" class="nav-link" data-toggle="modal">messages</a></li>
                <li class="nav-item"><a href="{{ asset('sosmed/notification.html') }}" class="nav-link">docs</a></li>
            ...
            <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="" class="rounded-circle ml-3 d-none d-md-block" width="32px" height="32px">
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-unstyled">
                     ...
                     <a href="#" class="text-decoration-none">
                        <li class="media hover-media">
                                ...
                                <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="img" width="60px" height="60px" class="rounded-circle mr-3">
                    ...
                    <a href="#" class="text-decoration-none">
                            <li class="media hover-media">
                                    ...
                                    <img src="{{ asset('sosmed/img/avatar-fat.jpg') }}" alt="img" width="60px" height="60px" class="rounded-circle mr-3">
                        ...
                        <a href="#" class="text-decoration-none">
                            <li class="media hover-media">
                                    ...
                                    <img src="{{ asset('sosmed/img/avatar-mdo.png') }}" alt="img" width="60px" height="60px" class="rounded-circle mr-3">
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="left-column">
                    ...
                    <div class="card card-left1 mb-4" >
                        <img src="{{ asset('sosmed/img/photo-1455448972184-de647495d428.jpg') }}" alt="" class="card-img-top img-fluid">
                        <div class="card-body text-center ">
                            <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="img" width="120px" height="120px" class="rounded-circle mt-n5">
                    ...
                    <div class="card shadow-sm card-left3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6 p-1">
                                    <a href="{{ asset('sosmed/img/left1.jpg') }}" data-lightbox="id" ><img src="{{ asset('sosmed/img/left1.jpg') }}" alt="img" class="img-fluid my-2"></a>  
                                    <a href="{{ asset('sosmed/img/left2.jpg') }}"data-lightbox="id"><img src="{{ asset('sosmed/img/left2.jpg') }}" alt="img" class="img-fluid my-2"></a>
                                    <a href="{{ asset('sosmed/img/left3.jpg') }}"data-lightbox="id"><img src="{{ asset('sosmed/img/left3.jpg') }}" alt="img" class="img-fluid my-2"></a>

                                </div>


                                <div class="col-6 p-1">
                                        <a href="{{ asset('sosmed/img/left4.jpg') }}"data-lightbox="id"><img src="{{ asset('sosmed/img/left4.jpg') }}" alt="img" class="img-fluid my-2"></a>
                                        <a href="{{ asset('sosmed/img/left5.jpg') }}"data-lightbox="id"><img src="{{ asset('sosmed/img/left5.jpg') }}" alt="img" class="img-fluid my-2"></a>
                                        <a href="{{ asset('sosmed/img/left6.jpg') }}"data-lightbox="id"><img src="{{ asset('sosmed/img/left6.jpg') }}" alt="img" class="img-fluid my-2"></a>
 ...
 <!---------------------------------------Middle columns  start---------------->
   ...
   <div class="card-body">
    ...
    <div class="media">
        <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="img" width="55px" height="55px" class="rounded-circle mr-3">
        ...
        <div class="media-body">
            ...
            <div class="row no-gutters mb-3">
                <div class="col-6 p-1 text-center">
                        ...
                        <img src="{{ asset('sosmed/img/adventure-alps-clouds-2259810.jpg') }}" alt="" class="img-fluid mb-2">
                        <img src="{{ asset('sosmed/img/aerial-view-architectural-design-buildings-2228123.jpg') }}" alt="" class="img-fluid">
                ...
                <div class="col-6 p-1 text-center">
                        ...
                        <img src="{{ asset('sosmed/img/celebration-colored-smoke-dark-2297472.jpg') }}" alt="" class="img-fluid mb-2">
                        <img src="{{ asset('sosmed/img/bodybuilding-exercise-fitness-2294361.jpg') }}" alt=""class="img-fluid">
            ...
            <div class="media mb-3">
                    <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="img" width="45px" height="45px" class="rounded-circle mr-2">
                    <div class="media-body">
            ...
            <div class="media">
                    <img src="{{ asset('sosmed/img/avatar-mdo.png') }}" alt="img" width="45px" height="45px" class="rounded-circle mr-2">
                    <div class="media-body">
...
<div class="card-body">
    ...
    <div class="media">
            <img src="{{ asset('sosmed/img/avatar-fat.jpg') }}" alt="img" width="55px" height="55px" class="rounded-circle mr-3">
...
<div class="card-body">
    ...
    <div class="media">
            ...
            <img src="{{ asset('sosmed/img/avatar-mdo.png') }}" alt="img" width="55px" height="55px" class="rounded-circle mr-3">
            <div class="media-body">
                <h5>Mark Otto</h5>
             ...
             <a href="{{ asset('sosmed/img/mid5.jpg') }}" data-lightbox="id"><img src="{{ asset('sosmed/img/mid5.jpg') }}" alt="" class="img-fluid shadow-sm img-thumbnail">   </a>   
    ...
    <div class="right-column">
        ...
        <div class="card shadow-sm mb-4" >
            <div class="card-body">
                ...
                <img src="{{ asset('sosmed/img/right1.jpg') }}" alt="card-img" class="card-img mb-3">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                    ...
                    <div class="row no-gutters d-none d-lg-flex">
                        <div class="col-6 p-1">
                                <img src="{{ asset('sosmed/img/avatar-dhg.png') }}" alt="img" width="80px" height="80px" class="rounded-circle mb-4">
                                <img src="{{ asset('sosmed/img/avatar-fat.jpg') }}" alt="img" width="80px" height="80px" class="rounded-circle">
